...
class CompaniesServicesResource extends BaseResource
{
    /**
     * Create a resource
     *
    ...
    {
        $companiesServices = $this->service->fetchAllPaginated($params, $params['sort'] ?? []);

        return new CompaniesCollection(new PaginatedAdapter($companiesServices));
    }
